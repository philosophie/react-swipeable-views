...
class SwipeableViews extends React.Component {
  ...
  setIndexCurrent(indexCurrent) {
    ...
    if (this.containerNode) {
      ...
      const transform = axisProperties.transform[axis](indexCurrent * this.props.transformScale);
...
So animateHeight is most likely having no effect at all.`,
    ...
    if (!renderOnlyActive) {
      const transform = axisProperties.transform[axis](this.indexCurrent * transformScale);
